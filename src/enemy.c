    ...
    switch(id)
    {
        ...
        return (Enemy){
            ...
            (CreatureStats){
                ...
                .temporaryStats = {},
                .lingeringEffects = {},
                .abilities = InitAbilities((ABILITY[]){AB_MIMIC_CHOMP,AB_MIMIC_IMPALE,AB_MIMIC_PETRIFY,AB_WAIT}, 4),
                .abilityCount = 4,
            },
            TG_WEIGHTED_RANDOM,
            AB_WAIT,
        ...
        return (Enemy){
            ...
            (CreatureStats){
                ...
                .temporaryStats = {},
                .lingeringEffects = {},
                .abilities = InitAbilities((ABILITY[]){AB_CAUCUBE_NIBBLE,AB_CAUCUBE_SPLIT,AB_CAUCUBE_METABOLIZE,AB_WAIT}, 4),
                .abilityCount = 4,
            },
            TG_WEIGHTED_RANDOM,
            AB_WAIT,
        ...
        return (Enemy){
            ...
            (CreatureStats){
                ...
                .temporaryStats = {},
                .lingeringEffects = {},
                .abilities = InitAbilities((ABILITY[]){AB_CAUCUBE_NIBBLE,AB_CAUCUBE_METABOLIZE,AB_WAIT}, 3),
                .abilityCount = 3,
            },
            TG_FRONT,
            AB_WAIT,
        ...
        return (Enemy){
            ...
            (CreatureStats){
                ...
                .temporaryStats = {},
                .lingeringEffects = {},
                .abilities = InitAbilities((ABILITY[]){AB_TOOFAIRY_SUMMON,AB_TOOFAIRY_CALCINIZE,AB_TOOFAIRY_BONEDUST,AB_WAIT}, 4),
                .abilityCount = 4,
            },
            TG_WEIGHTED_RANDOM,
            AB_WAIT,
        ...
        return (Enemy){
            ...
            (CreatureStats){
                ...
                .temporaryStats = {},
                .lingeringEffects = {},
                .abilities = InitAbilities((ABILITY[]){AB_TOOTHOLEM_STRIKE,AB_TOOTHOLEM_HARDEN,AB_TOOTHOLEM_PROTECT,AB_WAIT}, 4),
                .abilityCount = 4,
            },
            TG_FRONT,
            AB_WAIT,
        ...
        return (Enemy){
            ...
            (CreatureStats){
                ...
                .temporaryStats = {},
                .lingeringEffects = {},
                .abilities = InitAbilities((ABILITY[]){AB_STEVENANT_SIPHON, AB_STEVENANT_PHASING_STRIKE,AB_STEVENANT_ECTOPLASMIC_MANIFESTATION,AB_WAIT}, 4),
                .abilityCount = 4,
            },
            TG_TRUE_RANDOM,
            AB_WAIT,
